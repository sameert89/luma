...
Status: accepted for stages 1 and 2.
...
The client uses Tailwind tokens and shared native controls. Radix Dialog is the first approved interactive primitive; use the corresponding Radix primitive as other interactions arrive. TanStack Query owns request lifecycle. Virtualization arrives with collections in stage 4; no collection is rendered in stage 2.
