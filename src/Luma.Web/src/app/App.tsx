...
export function App() {
  ...
  const folderCards = section === 'library' && folders.data?.items.length ? <section aria-label="Folders" className="grid grid-cols-[repeat(auto-fit,minmax(9rem,1fr))] gap-3 pb-4">
    {folders.data.items.map(folder => <article key={folder.id} className="relative overflow-hidden rounded-xl border border-line bg-surface hover:border-accent">
