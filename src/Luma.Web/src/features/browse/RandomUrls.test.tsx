...
it('generates content URLs from visible filters and exposes only supported random content types', async () => {
  render(<RandomUrls filters={{ libraryId: 1, folderId: 2, tag: ['A', 'B'], tagMode: 'any', collectionTag: 'C', recursive: true, q: 'trip', mediaType: 'video', groupBy: 'folder', sort: 'shuffle', seed: 'seed', cursor: 'old', limit: 60 }} />)
