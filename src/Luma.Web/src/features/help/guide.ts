  ...
  },
  {
    ...
    groups: [
      ...
      { title: 'Video playback', entries: [
        ...
        { label: 'Volume', name: 'Volume slider', where: 'Video control bar (hidden on upright phones, where the device buttons set volume)', what: 'Sets the volume in fine steps.' },
