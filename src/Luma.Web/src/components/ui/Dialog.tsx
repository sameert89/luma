...
export function Dialog({ trigger, title, description, children }: {
    ...
    <DialogPrimitive.Root>
      ...
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content className="fixed left-1/2 top-1/2 z-50 w-11/12 max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-lg border border-line bg-canvas p-6 shadow-lg">
          ...
          <DialogPrimitive.Description className="mt-3 leading-relaxed text-muted">{description}</DialogPrimitive.Description>
          {children}
          <DialogPrimitive.Close asChild><Button className="mt-6">Close</Button></DialogPrimitive.Close>
