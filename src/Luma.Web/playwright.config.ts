...
export default defineConfig({
  ...
  fullyParallel: false,
  workers: 1,
  // The app's service worker never handles /api, but blocking it keeps page.route() interception deterministic.
  ...
  webServer: [
    {
      ...
      env: {
        ...
        Luma__Indexing__SourceVerificationIntervalSeconds: '86400',
      },
    },
