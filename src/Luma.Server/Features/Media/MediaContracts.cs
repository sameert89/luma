...
public sealed class MediaRow
{
    ...
    public string ModifiedAt { get; set; } = ""; public long ModifiedTicks { get; set; }
    public string EffectiveDate { get; set; } = "";
    public string? CapturedAt { get; set; }
    public string Preference { get; set; } = ""; public string Availability { get; set; } = "";
    public long EffectiveTicks { get; set; }
    public string NameKey { get; set; } = ""; public long RandomKey { get; set; }
